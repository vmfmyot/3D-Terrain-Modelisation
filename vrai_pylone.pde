...
void setup(){
  size(600, 600, P3D);
  //PVector[][] t = new PVector[4][4];
  //p0 = pylone(300, 50, 50, 50, t, 0);
}


//paramètres : hauteur et coordonnées du pylône

public PShape pylone(float h, float x, float y, float z, PVector[][] tab, int indice){
  strokeWeight(3);
  stroke(50);
  // POINTS
